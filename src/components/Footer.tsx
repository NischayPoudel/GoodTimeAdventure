      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent mb-4">Goodtime Adventure</h3>
            <p className="text-gray-400 leading-relaxed">Your trusted trekking partner in Nepal, bringing unforgettable Himalayan experiences to adventurers worldwide.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-400 hover:text-blue-400 transition-colors duration-200 font-medium">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">info@goodtimeadventure.com</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
