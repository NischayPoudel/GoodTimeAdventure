      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="group">
            <h3 className="text-2xl font-bold gradient-text mb-4">Goodtime</h3>
            <p className="text-white/70 leading-relaxed group-hover:text-white/90 transition-colors">Your trusted trekking partner in Nepal, bringing unforgettable Himalayan experiences to adventurers worldwide.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-white/70 hover:text-cyan-400 transition-colors duration-300 font-medium group">
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 group cursor-pointer">
                ...
                <span className="text-white/70 group-hover:text-white transition-colors">info@goodtimeadventure.com</span>
              </div>
              <div className="flex items-start space-x-3 group cursor-pointer">
                <svg className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-white/70 group-hover:text-white transition-colors">+977 1 234 5678</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-white/70 hover:text-cyan-400 transition-colors duration-300 group">
              <span className="relative">
                Twitter
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-cyan-400 group-hover:w-full transition-all duration-300"></span>
              </span>
